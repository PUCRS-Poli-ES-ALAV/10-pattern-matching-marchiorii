...
public class enunciado1 {
    ...
    public static int patternMatching(String s1, String s2) {
        ...
        // Caso de parada: algum dos dois é vazio
        ...
        for (int i = 0; i < s1.length() - s2.length(); i++) {
            contador++;
            String compare = s1.substring(i, i + s2.length() + 1);
            contador++;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(patternMatching(s3,s4));
        System.out.println("Iterações: " + contador);

        contador = 0;

        System.out.println(patternMatching(s1,s2));
        System.out.println("Iterações: " + contador);
    }
}